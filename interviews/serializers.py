...
class InterviewSlotSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        # Validate business hours (8:00 AM - 10:00 PM)
        if data.get("start_time"):
            ...
            if data["start_time"] < business_start or data["start_time"] > business_end:
                raise serializers.ValidationError(
        ...
        if data.get("end_time"):
            ...
            if data["end_time"] < business_start or data["end_time"] > business_end:
                raise serializers.ValidationError(
