...
urlpatterns = [
    ...
    path(
        ...
        views.submit_coding_challenge,
        name="submit_coding_challenge",
    ),
    # --- NEW API ENDPOINTS FOR INTERVIEW RESULTS ---
    path(
        "api/results/<uuid:session_id>/",
        views.InterviewResultsAPIView.as_view(),
        name="interview_results_api",
    ),
    path(
        "api/results/",
        views.InterviewResultsListAPIView.as_view(),
        name="interview_results_list_api",
    ),
    path(
        "api/analytics/<uuid:session_id>/",
        views.InterviewAnalyticsAPIView.as_view(),
        name="interview_analytics_api",
    ),
    # --- NEW API ENDPOINTS FOR DATA LISTING ---
    path(
        "api/interview-sessions/",
        api_views.interview_sessions_api,
        name="interview_sessions_api",
    ),
    path(
        "api/interview-questions/",
        api_views.interview_questions_api,
        name="interview_questions_api",
    ),
    path(
        "api/code-submissions/",
        api_views.code_submissions_api,
        name="code_submissions_api",
    ),
